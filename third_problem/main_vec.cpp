...
int main() {
    double y0_scalar = 0;
    auto r1_scalar = first_method<double>(func, 0.0, 1.0, y0_scalar);
    auto r2_scalar = second_method<double>(func, 0.0, 1.0, y0_scalar);
    auto r3_scalar = third_method<double>(func, 0.0, 1.0, y0_scalar);
    std::cout << "First: " << r1_scalar << std::endl;
    std::cout << "Second: " << r1_scalar << std::endl;
    std::cout << "Third: " << r1_scalar << std::endl;
